...
extern CAN_TxHeaderTypeDef TxHeaderTHR;	// Right inverter throttle
extern CAN_TxHeaderTypeDef TxHeaderTHL;	// Left inverter throttle
extern CAN_TxHeaderTypeDef TxHeaderNMT; // NMT command
