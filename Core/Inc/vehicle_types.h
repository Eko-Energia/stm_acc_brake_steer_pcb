/**
  ...
  * - Enums for Engine and Charger statuses.
  ******************************************************************************
  */
...
typedef enum{
	...
	ENGINE_STOP_NEUTRAL,  					///< Engine is in Pre-Operational mode (Torque disabled).
	ENGINE_STOP_BLOCKED 			///< Engine is in Pre-Operational (NEUTRAL) mode, only reset can disable it.
}EngineState_e;
